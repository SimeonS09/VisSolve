...
public class SubstractionAnimation : MonoBehaviour
{
    ...
    public LineTransformations StartAnimation(decimal term1, Color color1, LineTransformations currentVisLine1, decimal term2, Color color2, LineTransformations currentVisLine2, Color color3)
    {
        ...
        if (term1 * term2 <= 0)
        {
            ...
            else 
            {
                ...
                if (line2.transform.localPosition != new Vector3(20, 20, -1) || line1.angle != 0)
                {
                    ...
                    seq.Join(gridzooming.UppdateGrid(4 + term2f, 4, 4 + term1f, 4));
                    seq.Join(line2.ChangeAngle(0));
                }
            }

            line3 = Instantiate(linePrefab, transform);
            line3.transform.localPosition = new Vector3(20 + 5*term2f, 20 + 0.3f*(Mathf.Abs(term1f)+Mathf.Abs(term2f)), -1);
            line3.color = color3;
            line3.color.a = 0f;
            line3.UpdateColors();
            ...
            { 
                ...
                seq.Append(line1.ChangeLength(term1f));
            }
            
            if (currentVisLine2 == null) 
            {
                seq.Append(line2.FadeIn());
                seq.Append(gridzooming.UppdateGrid(4 + term2f, 4, 4 + term1f, 4));
                seq.Join(line2.ChangeLength(term2f));
            }
            
            seq.Append(line3.FadeIn());
            seq.Append(line3.ChangeLength(term1f - term2f));
            seq.Join(gridzooming.UppdateGrid(4 + term2f, 4, 4 + term1f, 4 + 0.06f*(Mathf.Abs(term1f)+Mathf.Abs(term2f))));
        ...
        else if (Mathf.Abs(term1f) > Mathf.Abs(term2f))
        {
            ...
            {
                line2 = Instantiate(linePrefab, transform);
                line2.transform.localPosition = new Vector3(20, 20 + 0.3f*Mathf.Abs(term1f), -1);
                line2.color = color2;
                line2.color.a = 0f;
                line2.UpdateColors();
            }
            ...
            {
                line2 = currentVisLine2;
                if (line2.transform.localPosition != new Vector3(20, 20 + 0.3f*Mathf.Abs(term1f), -1) || line1.angle != 0)
                {
                    seq.Append(line2.ChangePosition(new Vector3(20, 20 + 0.3f*Mathf.Abs(term1f), -1)));
            ...
            line3 = Instantiate(linePrefab, transform);
            line3.transform.localPosition = new Vector3(20 + 5*term2f, 20 + 0.3f*Mathf.Abs(term1f), -1);
            line3.color = color3;
            line3.color.a = 0f;
            line3.UpdateColors();
            ...
            seq.Append(line3.ChangeLength(term1f - term2f));
            seq.Join(gridzooming.UppdateGrid(4 + term2f, 4 + 0.06f*Mathf.Abs(term1f), 4 + term1f,  4 + 0.06f*Mathf.Abs(term1f)));   
            seq.Append(line1.FadeOut());
            seq.Join(line2.FadeOut());
            seq.Join(animationControl.FinishCalculation("-"));
        ...
        else if (Mathf.Abs(term1f) <= Mathf.Abs(term2f)) 
        {
            ...
            {
                line2 = Instantiate(linePrefab, transform);
                line2.transform.localPosition = new Vector3(20, 20 + 0.3f*Mathf.Abs(term2f), -1);
                line2.color = color2;
                line2.color.a = 0f;
                line2.UpdateColors();
            }
            ...
            {
                line2 = currentVisLine2;
                if (line2.transform.localPosition != new Vector3(20, 20 + 0.3f*Mathf.Abs(term2f), -1) || line1.angle != 0)
                {
                    seq.Append(line2.ChangePosition(new Vector3(20, 20 + 0.3f*Mathf.Abs(term2f), -1)));
                    seq.Join(gridzooming.UppdateGrid(4, 4, 4 + term2f, 4 + 0.06f*Mathf.Abs(term2f)));
                    seq.Join(line2.ChangeAngle(0));
                }
            }

            line3 = Instantiate(linePrefab, transform);
            line3.transform.localPosition = new Vector3(20 + 5*term2f, 20, -1);
            line3.color = color3;
            line3.color.a = 0f;
            line3.UpdateColors();
            ...
            seq.Join(gridzooming.UppdateGrid(4 + term1f, 4, 4 + term2f, 4));
            seq.Append(line1.FadeOut());
            seq.Join(line2.FadeOut());
            seq.Join(animationControl.FinishCalculation("-"));
            seq.AppendCallback(() =>
